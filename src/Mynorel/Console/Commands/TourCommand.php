...
class TourCommand implements \Mynorel\Console\Contracts\CommandInterface
{
    ...
    public function execute(array $input, array &$output): int
    {
        ...
        StylizedPrinter::info("1. Models are characters. Try: php mynorel make:model Hero");
        StylizedPrinter::info("2. Controllers are narrators. Try: php mynorel make:controller WelcomeController");
        StylizedPrinter::info("3. Use Facades for narrative logic. Try: Narrative::chapter('intro')");
        StylizedPrinter::info("4. Use CLI for all features. Try: php mynorel resource:list --user=alice");
